...
const pronounsQuestionArray = ['ich?', 'du?', 'er?', 'sie?', 'es?', 'wir?', 'ihr?', 'Sie?'];
...
export const data = {
    ...
    "questions": [
        { id: 1, task: 'я делаю?', answer: 'mache ich?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 2, task: 'ты делаешь?', answer: 'machst du?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 3, task: 'он делает?', answer: 'macht er?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 4, task: 'она делает?', answer: 'macht sie?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 5, task: 'оно делает?', answer: 'macht es?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 6, task: 'мы делаем?', answer: 'machen wir?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 7, task: 'вы делаете?', answer: 'macht ihr?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 8, task: 'они делают?', answer: 'machen sie?', variants: machenArray, pronouns: pronounsQuestionArray },
        { id: 9, task: 'Вы делаете?', answer: 'machen Sie?', variants: machenArray, pronouns: pronounsQuestionArray },

        { id: 10, task: 'я говорю?', answer: 'sage ich?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 11, task: 'ты говоришь?', answer: 'sagst du?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 12, task: 'он говорит?', answer: 'sagt er?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 13, task: 'она говорит?', answer: 'sagt sie?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 14, task: 'оно говорит?', answer: 'sagt es?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 15, task: 'мы говорим?', answer: 'sagen wir?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 16, task: 'вы говорите?', answer: 'sagt ihr?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 17, task: 'они говорят?', answer: 'sagen sie?', variants: sagenArray, pronouns: pronounsQuestionArray },
        { id: 18, task: 'Вы говорите?', answer: 'sagen Sie?', variants: sagenArray, pronouns: pronounsQuestionArray },

        { id: 11, task: 'я спрашиваю?', answer: 'frage ich?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 12, task: 'ты спрашиваешь?', answer: 'fragst du?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 13, task: 'он спрашивает?', answer: 'fragt er?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 14, task: 'она спрашивает?', answer: 'fragt sie?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 15, task: 'оно спрашивает?', answer: 'fragt es?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 16, task: 'мы спрашиваем?', answer: 'fragen wir?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 17, task: 'вы спрашиваете?', answer: 'fragt ihr?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 18, task: 'они спршивают?', answer: 'fragen sie?', variants: fragenArray, pronouns: pronounsQuestionArray },
        { id: 19, task: 'Вы спрашиваете?', answer: 'fragen Sie?', variants: fragenArray, pronouns: pronounsQuestionArray },

        { id: 20, task: 'я люблю?', answer: 'liebe ich?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 21, task: 'ты любишь?', answer: 'liebst du?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 22, task: 'он любит?', answer: 'liebt er?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 23, task: 'она любит?', answer: 'liebt sie?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 24, task: 'оно любит?', answer: 'liebt es?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 25, task: 'мы любит?', answer: 'lieben wir?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 26, task: 'вы любите?', answer: 'liebt ihr?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 27, task: 'они любят?', answer: 'lieben sie?', variants: liebenArray, pronouns: pronounsQuestionArray },
        { id: 28, task: 'Вы любите?', answer: 'lieben Sie?', variants: liebenArray, pronouns: pronounsQuestionArray },

        { id: 29, task: 'я смеюсь?', answer: 'lache ich?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 30, task: 'ты смеёшься?', answer: 'lachst du?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 31, task: 'он смеётся?', answer: 'lacht er?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 32, task: 'она смеётся?', answer: 'lacht sie?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 33, task: 'оно смеётся?', answer: 'lacht es?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 34, task: 'мы смеёмся?', answer: 'lachen wir?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 35, task: 'вы смеётесь?', answer: 'lacht ihr?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 36, task: 'они смеются?', answer: 'lachen sie?', variants: lachenArray, pronouns: pronounsQuestionArray },
        { id: 37, task: 'Вы смеётесь?', answer: 'lachen Sie?', variants: lachenArray, pronouns: pronounsQuestionArray },

        { id: 38, task: 'я живу?', answer: 'wohne ich?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 39, task: 'ты живёшь?', answer: 'wohnst du?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 40, task: 'он живёт?', answer: 'wohnt er?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 41, task: 'она живёт?', answer: 'wohnt sie?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 42, task: 'оно живёт?', answer: 'wohnt es?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 43, task: 'мы живём?', answer: 'wohnen wir?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 44, task: 'вы живёте?', answer: 'wohnt ihr?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 45, task: 'они живут?', answer: 'wohnen sie?', variants: wohnenArray, pronouns: pronounsQuestionArray },
        { id: 46, task: 'Вы живёте?', answer: 'wohnen Sie?', variants: wohnenArray, pronouns: pronounsQuestionArray },

        { id: 47, task: 'я пою?', answer: 'singe ich?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 48, task: 'ты поёшь?', answer: 'singst du?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 49, task: 'он поёт?', answer: 'singt er?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 50, task: 'она поёт?', answer: 'singt sie?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 51, task: 'оно поёт?', answer: 'singt es?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 52, task: 'мы поём?', answer: 'singen wir?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 53, task: 'вы поёте?', answer: 'singt ihr?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 54, task: 'они поют?', answer: 'singen sie?', variants: singenArray, pronouns: pronounsQuestionArray },
        { id: 55, task: 'Вы поёте?', answer: 'singen Sie?', variants: singenArray, pronouns: pronounsQuestionArray },

        { id: 56, task: 'я танцую?', answer: 'tanze ich?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 57, task: 'ты танцуешь?', answer: 'tanzst du?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 58, task: 'он танцует?', answer: 'tanzt er?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 59, task: 'она танцует?', answer: 'tanzt sie?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 60, task: 'оно танцует?', answer: 'tanzt es?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 61, task: 'мы танцуем?', answer: 'tanzen wir?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 62, task: 'вы танцуете?', answer: 'tanzt ihr?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 63, task: 'они танцуют?', answer: 'tanzen sie?', variants: tanzenArray, pronouns: pronounsQuestionArray },
        { id: 64, task: 'Вы танцуете?', answer: 'tanzen Sie?', variants: tanzenArray, pronouns: pronounsQuestionArray },

        { id: 65, task: 'я играю?', answer: 'spiele ich?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 66, task: 'ты играешь?', answer: 'spielst du?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 67, task: 'он играет?', answer: 'spielt er?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 68, task: 'она играет?', answer: 'spielt sie?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 69, task: 'оно играет?', answer: 'spielt es?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 70, task: 'мы играем?', answer: 'spielen wir?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 71, task: 'вы играете?', answer: 'spielt ihr?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 72, task: 'они играют?', answer: 'spielen sie?', variants: spielenArray, pronouns: pronounsQuestionArray },
        { id: 73, task: 'Вы играете?', answer: 'spielen Sie?', variants: spielenArray, pronouns: pronounsQuestionArray },

        { id: 74, task: 'я работаю?', answer: 'arbeite ich?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 75, task: 'ты работаешь?', answer: 'arbeitest du?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 76, task: 'он работает?', answer: 'arbeitet er?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 77, task: 'она работает?', answer: 'arbeitet sie?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 78, task: 'оно работает?', answer: 'arbeitet es?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 79, task: 'мы работаем?', answer: 'arbeiten wir?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 80, task: 'вы работаете?', answer: 'arbeitet ihr?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 81, task: 'они работают?', answer: 'arbeiten sie?', variants: arbeitenArray, pronouns: pronounsQuestionArray },
        { id: 82, task: 'Вы работаете?', answer: 'arbeiten Sie?', variants: arbeitenArray, pronouns: pronounsQuestionArray },

        { id: 83, task: 'я отвечаю?', answer: 'antworte ich?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 84, task: 'ты отвечаешь?', answer: 'antwortest du?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 85, task: 'он отвечает?', answer: 'antwortet er?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 86, task: 'она отвечает?', answer: 'antwortet sie?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 87, task: 'оно отвечает?', answer: 'antwortet es?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 88, task: 'мы отвечаем?', answer: 'antworten wir?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 89, task: 'вы отвечаете?', answer: 'antwortet ihr?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 90, task: 'они отвечают?', answer: 'antworten sie?', variants: antwortenArray, pronouns: pronounsQuestionArray },
        { id: 91, task: 'Вы отвечаете?', answer: 'antworten Sie?', variants: antwortenArray, pronouns: pronounsQuestionArray },

        { id: 92, task: 'я слышу?', answer: 'höre ich?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 93, task: 'ты слышишь?', answer: 'hörst du?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 94, task: 'он слышет?', answer: 'hört er?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 95, task: 'она слышет?', answer: 'hört sie?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 96, task: 'оно слышет?', answer: 'hört es?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 97, task: 'мы слышим?', answer: 'hören wir?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 98, task: 'вы слышите?', answer: 'hört ihr?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 99, task: 'они слышут?', answer: 'hören sie?', variants: horenArray, pronouns: pronounsQuestionArray },
        { id: 100, task: 'Вы слышите?', answer: 'hören Sie?', variants: horenArray, pronouns: pronounsQuestionArray },
    ]
}