export const data = {
	...
	content: [
		[
			...
			{ id: 3, words: 'statements', timeline: true, rule: {type: 'simple', title: ''} },
			{ id: 4, words: 'questions', timeline: true, rule: {type: 'simple', title: ''} },
			{ id: 5, words: 'negatives', timeline: true, rule: {type: 'simple', title: ''} },
			{ id: 6, words: 'futures', timeline: true, rule: {type: 'simple', title: ''} },
